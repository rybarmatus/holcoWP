...
<div class="container kontakt_page">
  ...
  <div class="row">
    <div class="col-md-7">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="kontaktne_info">
                  <?php if($adresa_ulica = get_option('option_adresa_ulica')){ ?>
                    <div class="item">
                        <span>
                        ...
                        <strong><?= __('Adresa','goshop') ?>:</strong>
                        <?= $adresa_ulica; ?>,
            ...
            <?php if($goshop_config['contact_show_opening_hours']) { ?>
            <div class="col-md-6 mt-mobile-1">
                <h4><?= __('Otváracie hodiny', 'goshop'); ?></h4>
                <table>
                  <tr><th><?= __('Pondelok','goshop'); ?>:</th><td><?= get_option('option_opening_hours_1'); ?></td></tr>
                  <tr><th><?= __('Utorok','goshop'); ?>:</th><td><?= get_option('option_opening_hours_2'); ?></td></tr>
                  <tr><th><?= __('Streda','goshop'); ?>:</th><td><?= get_option('option_opening_hours_3'); ?></td></tr>
                  <tr><th><?= __('Štvrtok','goshop'); ?>:</th><td><?= get_option('option_opening_hours_4'); ?></td></tr>
                  <tr><th><?= __('Piatok','goshop'); ?>:</th><td><?= get_option('option_opening_hours_5'); ?></td></tr>
                  <tr><th><?= __('Sobota','goshop'); ?>:</th><td><?= get_option('option_opening_hours_6'); ?></td></tr>
                  <tr><th><?= __('Nedeľa','goshop'); ?>:</th><td><?= get_option('option_opening_hours_7'); ?></td></tr>
                </table>
            </div>
            <?php } ?>
        </div>
        ...
        <div class="row text-center mb-2 mt-3">
            ...
            <?php } ?>  
            <div class="col-md-6 kontaktne_info pt-5 socialne_siete pt-mobile-1">
                <?php show_socials(); ?>
            </div>
        </div>
         ...
         <?php
         if($goshop_config['contact_show_map']) {
            echo get_option('option_google_maps');
         } 
         ?>
    </div>
    <div class="col-md-5">
      <h2><?= __('Kontaktný formulár','goshop'); ?></h2>
      <?= do_shortcode('[contact-form-7 id="5" title="Kontaktný formulár 1"]'); ?>
    </div>
